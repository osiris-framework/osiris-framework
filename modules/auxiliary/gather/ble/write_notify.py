...
options = {
    ...
    'characteristic_notify': ['Yes', ' use to set characteristic notify to read your content', ''],
...
def exploit():
    ...
    try:
        ...
        __characteristic_notify = obtainer.options['characteristic_notify'][2]
        __data = obtainer.options['data'][2]
        __response = asyncio.run(bleakBLE.write_service_notify(__device, __characteristic, __characteristic_notify, __data, __timeout))
